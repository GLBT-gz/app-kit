  ...
  return (
    <div className="topbar" ref={topbarRef}>
      ...
      <div className="topbar-right" data-tauri-drag-region>
        {/* 设置按钮：hover 齿轮转 90°反馈，设置面板打开（active）转 180°（见 topbar.css .settings-gear） */}
        <button
          className={`settings-btn ${showSettings ? "active" : ""}`}
          onClick={onToggleSettings}
          title="设置"
        >
          <svg className="settings-gear" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* 主题切换：太阳/月亮双图标叠放，CSS 过渡实现丝滑切换动画 */}
        <button className="theme-toggle" onClick={onToggleTheme} title="切换主题">
          <svg className="tb-icon icon-sun" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <circle cx="12" cy="12" r="5" /><line x1="12" y1="1" x2="12" y2="3" /><line x1="12" y1="21" x2="12" y2="23" />
            <line x1="4.22" y1="4.22" x2="5.64" y2="5.64" /><line x1="18.36" y1="18.36" x2="19.78" y2="19.78" />
            <line x1="1" y1="12" x2="3" y2="12" /><line x1="21" y1="12" x2="23" y2="12" />
            <line x1="4.22" y1="19.78" x2="5.64" y2="18.36" /><line x1="18.36" y1="5.64" x2="19.78" y2="4.22" />
          </svg>
          <svg className="tb-icon icon-moon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" /></svg>
        </button>
      </div>
    </div>
  );
